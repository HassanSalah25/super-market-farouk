                            ...
                            <div class="product-item element-item1">
                                ...
                                <div class="quick-action-button">
                                    ...
                                    <div class="cta-single cta-wishlist">
                                        <a href="{{ route('frontend.products.single', $product->slug) }}"
                                           class="add_to_wishlist_ajax" data-id="{{ $product->id }}" ><i class="fal fa-heart"></i></a>
                                    </div>
                                    <div class="cta-single cta-addtocart">
                                        @if(isset($attributes) && $attributes > 0)
                                            <a href="{{ route('frontend.products.single', $product->slug) }}"><i class="rt-basket-shopping"></i></a>
                                        @else
