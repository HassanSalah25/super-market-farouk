...
class ProductSliderSix extends PageBuilderBase
{
    use RepeaterHelper;
    ...
    public function frontend_render(): string
    {
        ...
        return $this->renderBlade('product.product_slider_six', $section_data);
    }
}
