...
class ProductSliderFive extends PageBuilderBase
{
    use RepeaterHelper;
    ...
    public function frontend_render(): string
    {
        ...
        return $this->renderBlade('product.product_slider_five', $section_data);
    }
}
