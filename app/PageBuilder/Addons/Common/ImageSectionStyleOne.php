...
<div class="container-1">
    <div class="image-wrap">
        <div class="shoppable-wrapper" style="top:50%;left: 70%;">
            <a class="dot" href="#product"></a>
            <a class="tooltip" href="#product">
                <span class="productname">Table</span>
                <span class="short-description">Short description/&shy;category</span>
                <span class="price">9.99 DKK</span>
            </a>
        </div>
        <a class="image" href="#page">
                {$image_markup}
            < </a>
    </div>
</div>
