                            ...
                            <div class="product-item element-item1">
                                ...
                                <div class="quick-action-button">
                                    ...
                                    <div class="cta-single cta-wishlist">
                                        <a href="<?php echo e(route('frontend.products.single', $product->slug)); ?>"
                                           class="add_to_wishlist_ajax" data-id="<?php echo e($product->id); ?>" ><i class="fal fa-heart"></i></a>
                                    </div>
                                    <div class="cta-single cta-addtocart">
                                        <?php if(isset($attributes) && $attributes > 0): ?>
                                            <a href="<?php echo e(route('frontend.products.single', $product->slug)); ?>"><i class="rt-basket-shopping"></i></a>
                                        <?php else: ?>
...
<!--================= New Collection supermarket  Section End Here =================-->
<?php /**PATH C:\Users\Administrator\Local Sites\el-farouk-ecommerce\app\public\@core\app\Providers/../PageBuilder/views/product/product_slider_four.blade.php ENDPATH**/ ?>